...
- `git clone git@github.com:tryber/sd-07-restaurant-orders.git`.
- Entre na pasta do repositório que você acabou de clonar:
  - `sd-07-restaurant-orders`
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-07-restaurant-orders/pulls)
